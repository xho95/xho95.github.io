...
제가 레진에 지원하려고 하면서, 레진에 기여할 수 있다고 생각했던 것들과 제가 살아온 배경을 설명드리도록 하겠습니다.

## 왜 레진에 지원하려고 하는가?

처음에 레진에서 게임개발자를 모집한다는 글을 보고나서 여러차례 고민을 거듭하다가, 최종적으로 레진에 지원하려고 결심하게 된 이유는 **한 명의 개발자로서 세상에 기억될 것을 만들고 싶다**는 소망을 가지고 있기 때문입니다. 
 
저는 원래 인생의 대부분을 부산에서 살 던 사람인데, 최근에 서울로 상경해서 현재는 모두의연구소에서 매니저 생활을 하고 있습니다. 매니저 생활도 나름 의미가 있지만, 항상 가슴 한 곳에서는 개발자이고 싶은 마음이 있었습니다.  
