...
위의 제안과 더불어 제가 현재 레진에 기여할 수 있다고 생각되는 부분을 정리해봤습니다.

1. **다양한 분야의 게임**에 대해서 프로토타입을 만들 수 있습니다.
	* [포트폴리오](2016-07-21-Portfolio.md)를 보시면 아시겠지만 Swift로 다양한 게임을 제작해 본 경험이 있습니다.
	* 당연히, Unity, Unreal Engine 같은 멀티플랫폼 도구도 써야하지만 **표준 UI** 나 **In-App purchase** 등의 iOS 용에 특화된 기술도 다룰 개발자도 필요하다고 생각함, 이부분에서 도움을 줄 수 있음
	
2. Swift를 활용하여 게임 이외의 앱도 제작할 수 있습니다.	
	* 구글에서도 Swift를 고려할 정도로 향후에 Swift가 다른 플랫폼용 개발 언어로도 확장될 가능성 있음
	* Swift로 iOS 개발 경험을 살려서 watchOS, tvOS 게임을 개발할 수 있음
	
3. iMessage 앱 등 **iOS 신규 시장에 진출하여 새로운 매출**을 창출하는데 도움을 드릴 수 있습니다.
...
4. 모바일 기기를 위한 **신규 제품 개발**에 참여하여 도움을 줄 수 있습니다.
...
5. 기계공학이 전공이라 메카닉 개념 설계나 설정 구축에 도움을 줄 수 있습니다.
...
* 덕질 하고 있는 것
	1. Swift : C++ 이후로 제 2의 인생을 살고 있는 느낌을 줌
	2. 지도 보는 것을 좋아함. 현재는 맥을 쓰다보니 국내는 다음 지도를 보고 해외는 애플 지도를 활용하고 있음

	3. FreeCell : 몇몇판의 세계 기록을 가지고 있음
