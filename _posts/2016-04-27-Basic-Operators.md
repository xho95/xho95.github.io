...
이 장은 스위프트에서 일반적으로 흔한 연산자를 설명합니다. [Advanced Operators (고급 연산자)]({% post_url 2020-05-11-Advanced-Operators %}) 에서 스위프트의 고급 연산자를 다루며, 자신만의 연산자를 정의 방법과 자신만의 타입을 위한 표준 연산자 구현 방법도 설명합니다.
