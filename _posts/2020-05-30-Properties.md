...
이에 더하여, 속성의 값이 바뀌는 걸 감시하는 '속성 관찰자 (property observers)' 를 정의할 수 있는데, 이로써 응답시 사용자 정의 행동을 할 수 있습니다. '속성 관찰자' 는 자신이 직접 정의한 '저장 속성' 에 추가할 수 있으며, 상위 클래스에서 하위 클래스가 상속 받은 속성에도 추가할 수 있습니다.
