...
매개 변수 이름 앞의 이름은 매개 변수에, 매개 변수 이름과는 다를 수 있는, '명시적인 인자 이름표' 를 부여니다. 관련 인자는 함수나 메소드 호출에서 반드시 '주어진 인자 이름표' 를 사용해야 합니다.

매개 변수 이름 앞의 '밑줄 (`_`)' 은 '인자 이름표' 를 억제합니다. 관련 인자는 함수나 메소드 호출에서 반드시 이름표가 없어야 합니다.
