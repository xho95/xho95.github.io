...
_선언 수정자 (declaration modifiers)_ 는 선언의 동작이나 의미를 수정하는 '키워드' 또는 '상황에-민감한 (context-sensitive) 키워드'[^context-sensitive] 입니다. '선언 수정자' 는 '선언의 특성 (이 있으면) 이들과 선언을 도입한 키워드' 사이에 적절한 '키워드' 또는 '상황에-민감한 키워드' 를 작성함으로써 지정합니다.
