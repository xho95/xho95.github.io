...
속성 관찰자는 어떤 저장 속성에라도 추가할 수 있습니다. 속성 관찰자는 또한, [Overriding Property Observers (속성 관찰자 재정의하기)]({% post_url 2020-03-31-Inheritance %}#overriding-property-observers-속성-관찰자-재정의하기) 에서 설명한 것처럼, 하위 클래스에서 속성을 재정의하는 것으로써 (저장 속성인지 계산 속성인지 상관없이) 상속한 어떤 속성에도 추가할 수 있습니다.
