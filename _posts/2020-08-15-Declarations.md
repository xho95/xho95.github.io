...
&nbsp;&nbsp;&nbsp;&nbsp;이 수정자를 선언에 적용하면 선언과 동일한 모듈의 코드가 선언의 접근과 하위 클래스 만들기를 할 수 있다는 걸 지시합니다. `open` 접근-수준 수정자를 표시한 선언은 그 선언이 담긴 모듈을 불러온 모듈 코드도 접근과 하위 클래스 만들기를 할 수 있습니다.

`public`

&nbsp;&nbsp;&nbsp;&nbsp;이 수정자를 선언에 적용하면 선언과 동일한 모듈의 코드가 선언의 접근과 하위 클래스 만들기를 할 수 있다는 걸 지시합니다. `public` 접근-수준 수정자를 표시한 선언은 그 선언이 담긴 모듈을 불러온 모듈 코드도 접근을 (하위 클래스 만들기는 안되지만) 할 수 있습니다.
