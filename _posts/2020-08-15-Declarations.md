...
&nbsp;&nbsp;&nbsp;&nbsp;이 수정자를 선언에 적용하면 선언과 동일한 모듈 안의 코드가 선언에 접근하고 하위 클래스를 만들 수 있다' 는 것을 지시하기 위해 선언에 적용합니다. '`open` 접근-수준 수정자로 표시한 선언' 은 '해당 선언을 담은 모듈을 불러온 모듈 코드' 도 접근하고 하위 클래스를 만들 수 있습니다.
