...
`throws` 키워드는 함수 타입의 일부분이며, '던지지 않는 (nonthrowing) 함수' 는 '던지는 함수' 의 하위 타입입니다. 그 결과, '던지지 것' 을 예상하고 있는 곳에서 '던지지 않는 함수' 를 사용할 수 있습니다.
...
`async` 키워드는 함수 타입의 일부분이며, '동기 (synchronous) 함수' 는 '비동기 함수' 의 하위 타입입니다. 그 결과, '비동기 함수' 를 예상하고 있는 곳에서 '동기 함수' 를 사용할 수 있습니다. 예를 들어, '비동기 메소드' 를 '동기 메소드' 로 재정의할 수 있으며, '비동기 메소드' 를 요구하는 '프로토콜 필수 조건' 을 '동기 메소드' 로 만족할 수도 있습니다. 
