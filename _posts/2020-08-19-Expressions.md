...
'옵셔널-연쇄 표현식' 으로 '포장을 푼 값 (unwrapped value)' 은, 값 자체를 변경하거나, 값의 멤버 중 하나에 할당하는 것으로, 수정할 수 있습니다. 만약 옵셔널-연쇄 표현식의 값이 `nil` 이면, 할당 연산자의 오른-쪽에 있는 표현식은 평가하지 않습니다. 예를 들면 다음과 같습니다:
