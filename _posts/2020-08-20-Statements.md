...
`
do {<br />  try `expression-표현식`<br />  `statements-구문`<br />} catch `pattern 1-유형 1` {<br /> `statements-구문`<br />} catch `pattern 2-유형 2` where `condition-조건` {<br />  `statements-구문`<br />} catch `pattern 3-유형 3`, `pattern 4-유형 4` where `condition-조건` {<br />  `statements-구문`<br />} catch {<br />  `statements-구문`<br />}
