...
* [Patterns (패턴; 유형)]({% post_url 2020-08-25-Patterns %}) ![5.5](https://img.shields.io/badge/-%205.5-yellow)
* [Generic Parameters and Arguments (일반화 매개 변수와 인자)]({% post_url 2017-03-16-Generic-Parameters-and-Arguments %}) ![5.4 inactive](https://img.shields.io/badge/-%205.5-inactive)
