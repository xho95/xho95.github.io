...
스위프트의 모든 함수엔 타입이 있는데, 함수의 매개 변수 타입 및 반환 타입으로 구성됩니다. 이 타입은 스위프트의 다른 어떤 타입인 것 같이 쓸 수 있는데, 함수를 다른 함수의 매개 변수로 전달하고, 함수에서 함수를 반환하는 걸, 하기 쉽게 합니다. 함수를 다른 함수 안에 작성할 수 있어서 유용한 기능을 중첩된 함수 시야 안으로 감출 수도 있습니다.
