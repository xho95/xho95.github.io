...
스위프트의 모든 함수는, 함수의 매개 변수 타입과 반환 타입으로 구성된, 타입을 가집니다. 스위프트의 다른 어떤 타입 같이 이 타입을 사용할 수 있는데, 이는 다른 함수의 매개 변수로 함수를 전달하고, 함수가 함수를 반환하는 걸, 하기 쉽게 해줍니다. 유용한 기능을 중첩 함수 영역 안에 은닉하고자 다른 함수 안에 함수를 작성할 수도 있습니다.
