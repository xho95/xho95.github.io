...
* [Enumeration Case Pattern (열거체 case 값 패턴)]({% post_url 2020-06-13-Enumerations %}#enumeration-case-pattern-열거체-case-값-패턴) 부분을 갱신했으며, 이제 '열거체 case 값 패턴' 도 옵셔널 값과 일치할 수 있음.
