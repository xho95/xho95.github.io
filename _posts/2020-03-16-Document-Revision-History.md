...
* '열거체 case 값 (enumeration cases)' 을 함수처럼 사용하는 것에 대한 정보를 [Enumerations with Cases of Any Type (어떤 타입이어도 되는 'case 값' 을 가진 열거체)]({% post_url 2020-08-15-Declarations %}#enumerations-with-cases-of-any-type-어떤-타입이어도-되는-case-값-을-가진-열거체) 부분에 추가함.
