...
외부 소스에서 크기를 명시한 자료이거나, 성능 및, 메모리 사용량을 위해, 또는 그 외 필요한 최적화 때문에, 특히 당장 필요한 임무일 때만 다른 정수 타입을 사용합니다. 이러한 상황에서 크기를 명시한 타입을 사용하면 어떤 값 넘침 사고든 잡아내게 돕고 사용 중인 자료의 고유 성질을 암시적으로 문서화합니다.[^documents]
