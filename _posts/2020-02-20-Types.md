...
'암시적으로 포장이 풀리는 옵셔널 타입' 에 대한 더 많은 정보는, [implicitly Unwrapped Optionals (암시적으로 포장을 푸는 옵셔널)]({% post_url 2016-04-24-The-Basics %}#implicitly-unwrapped-optionals-암시적으로-포장을-푸는-옵셔널) 부분을 참고하기 바랍니다.
