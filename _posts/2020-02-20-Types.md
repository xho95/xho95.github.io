...
[^heterogeneous-array]: '혼성 배열 (heterogeneous array)' 은 배열 안의 객체들이 모두 다른 클래스이지만, 공통의 상위 클래스를 가지는 배열을 의미합니다. 혼성 배열에 대한 더 자세한 정보는, 'MathWorks' 의 [Designing Heterogeneous Class Hierarchies](https://www.mathworks.com/help/matlab/matlab_oop/heterogeneous-arrays.html) 항목을 참고하기 바랍니다. 
