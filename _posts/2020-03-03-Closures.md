...
클로저는 자신을 정의한 곳에 있는 어떤 상수와 변수의 참조든 붙잡고[^capture] 저장할 수 있습니다. 이를 그 상수와 변수를 _잠근다 (closing over)_ 라고 합니다. 스위프트는 붙잡는데 필요한 모든 메모리 관리를 직접 처리합니다.
