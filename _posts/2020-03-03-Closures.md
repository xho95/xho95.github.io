...
스위프트에서, 값을 붙잡을 수 있는 클로저의 가장 간단한 것은 '중첩 함수 (nested function)' 인데, 이는 다른 함수 본문 안에 작성하는 방식입니다. 중첩 함수는 자기 외부 함수의 인자는 어느 것이든 붙잡을 수 있으며 외부 함수 내에 정의되어 있으면 상수와 변수도 어느 것이든 붙잡을 수 있습니다.
...
[^guaranteed]: `number % 10` 의 결과는 항상 '0...9' 사이의 정수 중 하나입니다.
