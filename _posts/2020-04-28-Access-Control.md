...
프로토콜 타입의 접근 수준을 명시적으로 할당하고 싶으면, 프로토콜 정의 시점에 그렇게 합니다. 이는 특정한 접근 상황에서만 채택 가능한 프로토콜을 생성할 수 있게 합니다.

프로토콜 정의 안에 있는 각 필수 조건의 접근 수준은 자동으로 프로토콜과 동일한 접근 수준으로 설정합니다. 프로토콜의 필수 조건에 자신이 지원하는 프로토콜과 다른 접근 수준을 설정할 순 없습니다. 이는 프로토콜을 채택한 어떤 타입이든 프로토콜의 모든 필수 조건을 볼 수 있도록 보장합니다.
