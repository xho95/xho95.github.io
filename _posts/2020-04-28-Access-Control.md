...
타입은 타입 그 자체보다 더 낮은 접근 수준으로 프로토콜을 준수할 수 있습니다. 예를 들어, 다른 모듈에서 쓸 수 있는 공용 프로토콜을 정의했지만, 그게 준수한 프로토콜은 내부 프로토콜의 정의 모듈 안에서만 쓸 수 있는 내부 프로토콜일 수 있습니다.

한 특별한 프로토콜을 준수한 타입의 접근 수준은 타입과 프로토콜의 최소값[^the-minimum] 입니다. 예를 들어, 타입은 공용 (public) 이지만, 그게 준수한 프로토콜은 내부 (internal) 면, 해당 프로토콜에 대한 타입의 준수성도 '내부 (internal)' 입니다.
...
[^the-minimum]: 타입과 타입이 준수한 프로토콜의 접근 수준이 다르면 (가장 낮은) 최소 접근 수준을 가진다는 의미입니다.
