...
이 특성을 익스텐션에 적용하는 건 '`nonobjc` 특성을 명시하지 않은 모든 해당 익스텐션 멤버에 이를 적용한 것' 과 똑같은 실제 효과를 가집니다.
...
결과 제작자 특성의 적용은 'ABI 호환성' 에 충격을 주지 않습니다. 결과 제작자 특성을 매개 변수에 적용하면 해당 특성이 함수 인터페이스 일부가 되어, 소스 호환성에 실제 효과를 줄 수 있습니다.
