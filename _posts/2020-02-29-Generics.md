...
layout: post
comments: true
title:  "Swift 5.4: Generics (제네릭; 일반화)"
date:   2020-02-29 11:30:00 +0900
categories: Swift Language Grammar Generic
---

> Apple 에서 공개한 [The Swift Programming Language (Swift 5.4)](https://docs.swift.org/swift-book/) 책의 [Generics](https://docs.swift.org/swift-book/LanguageGuide/Generics.html) 부분[^Generics]을 번역하고, 설명이 필요한 부분은 주석을 달아서 정리한 글입니다.
>
