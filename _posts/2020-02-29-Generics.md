...
[^hashable]: '해시 가능 (hashable)' 은 본문 바로 뒤에 나오듯이, 자신을 유일하게 나타낼 수 있는 방법을 제공할 수 있다는 의미입니다. 해시 가능에 대한 더 자세한 정보는, [Collection Types (집합체 타입)]({% post_url 2016-06-06-Collection-Types %}) 장의 [Hash Values for Set Types (셋 타입을 위한 해시 값)]({% post_url 2016-06-06-Collection-Types %}#hash-values-for-set-types-셋-타입을-위한-해시-값) 부분을 보도록 합니다.
