...
프로토콜은 클래스, 구조체, 및 열거체와 아주 비슷하게 정의합니다:
...
사용자 정의 타입은, 정의 부분에서, 타입 이름 뒤에, 콜론으로 구분한, 프로토콜 이름을 둠으로써 한 특별한 프로토콜을 채택한다고 알립니다. 쉼표로 구분하여, 여러 개의 프로토콜을 나열할 수도 있습니다:
...
클래스에 상위 클래스가 있으면, 채택한 어떤 프로토콜 보다 앞에 상위 클래스 이름을 나열하고, 그 뒤에 쉼표를 둡니다:
