...
프로토콜이 획득 가능하면서 설정 가능한 속성을 요구하면, 상수 저장 속성이나 읽기-전용 계산 속성으론 그 속성 필수 조건을 충족할 수 없습니다. 프로토콜이 획득 가능한 속성만 요구하면, 어떤 종류의 속성으로도 필수 조건을 만족할 수 있으며, 자신의 코드에 유용할 경우 속성을 설정도 가능하게 하는 것도 유효입니다.
