...
프로토콜은 어떤 준수 타입이든 특별한 이름과 타입의 인스턴스 속성 및 타입 속성을 제공할 것을 요구할 수 있습니다. 속성이 저장 속성이어야 하는지 계산 속성이어야 하는지는 프로토콜이 지정하지 않습니다-필요한 속성 이름과 타입만 지정합니다. 프로토콜은 각각의 속성이 반드시 획득 가능해야 하는지 아니면 획득 가능 _하면서 (and)_ 설정 가능해야 하는 지도 지정합니다.
