...
layout: post
comments: true
title:  "Swift 5.4: Generic Parameters and Arguments (일반화된 매개 변수와 일반화된 인자)"
...
> Apple 에서 공개한 [The Swift Programming Language (Swift 5.4)](https://docs.swift.org/swift-book/) 책의 [Generic Parameters and Arguments](https://docs.swift.org/swift-book/ReferenceManual/GenericParametersAndArguments.html) 부분[^Version-Compatibility]을 번역하고, 설명이 필요한 부분은 주석을 달아서 정리한 글입니다.
>
...
#### Generic Where Clauses (일반화환 'Where' 절)
...
일반화된 `where` 절에 대한 보다 많은 정보와 일반화된 함수 선언의 예를 보고 싶으면 [Generic Where Clauses (일반화한 'where' 절)]({% post_url 2020-02-29-Generics %}#generic-where-clauses-일반화한-where-절) 부분을 보면 됩니다.
