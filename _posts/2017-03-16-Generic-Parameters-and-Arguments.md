...
일반화된 `where` 구절에 대한 보다 많은 정보와 일반화된 함수 선언의 예를 보고 싶으면 [Generic Where Clauses (일반화된 Where 구절)]() 부분을 보면 됩니다.

```
http://xho95.github.io/swift/language/grammar/generic/2020/02/29/Generics.html#generic-where-clauses-일반화된-where-구절
```
