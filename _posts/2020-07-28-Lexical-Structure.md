...
스위프트의 _어휘 구조 (lexical structure)_ 는 언어에서 '유효한 낱말 (token)'[^token] 을 형성하는 일련의 문자들이 무엇인지를 설명합니다. 이 유효한 '낱말' 들이 언어에서 '가장 낮은-수준의 건축 자재' 를 형성하며 뒤이은 장에서 언어 나머지 부분을 설명하는데 사용합니다. '낱말' 은 '식별자 (identifier)', '키워드 (keyword)', '글자 값 (literal)', 및 '연산자 (operator)' 로 구성됩니다.
