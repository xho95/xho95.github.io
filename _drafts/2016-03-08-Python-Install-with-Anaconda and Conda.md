...
무료로 사용할 수 있는 파이썬 개발 도구 중에서는 아톰(Atom) 에디터도 괜찮은 편입니다. 아톰 에디터를 파이썬 개발에 사용하기 위해서는 [아톰 (Atom) 에디터 활용하기]({% 2016-09-28-Using-Atom-Editor %}) 에 따로 정리해 둔 내용이 있으니 살펴 보기 바랍니다.
