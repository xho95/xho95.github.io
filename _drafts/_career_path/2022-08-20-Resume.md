...
* **2013-10** : URAI 논문 제출 [UGV optimal path planning algorithm by using 3D survivability map]()
* **2013-09** : ICIRA 논문 제출 [3D Probability Map Building for UGV Navigation in Special Environment]()

#### 2012

* **2012-11** : URAI 논문 제출 [The development of the battle field simulation program using the survivability on the probability map]() 
* **2012-08** : ICIRA 논문 제출 [A Study of New Path Planning Algorithm Using Extended A* Algorithm with Survivability]() 
* **2012-06** : IAS 논문 제출 [A Study of Path Planning Algorithm Based on the Survival Probability]() 

#### 2011

* **2011-11** : URAI 논문 제출 [A path planning algorithm using artificial potential field based on probability map]()
* **2011-03** : 특수 환경 Navigation/Localization 로봇 기술 연구 참여 (2011-03 ~ 2013-12)

#### 2010

* **2010-10** : ICCAS 논문 제출 [A path generation method for path tracking algorithms that use the augmented reality]()
