...
사실 vi는 텍스트 편집기 일 뿐이므로 vi가 아니더라도 아무 편집기로 settings.py를 편집하면 되겠습니다. Atom 에디터를 python 개발에 사용하는 방법에 대해서는 [Atom 에디터 활용하기]({% post_url 2016-09-28-Using-Atom-Editor %}) 글을 참고하시면 됩니다. 
